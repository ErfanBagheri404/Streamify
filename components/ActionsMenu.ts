...
//         ${CollectionSelector({ collection: store.actionsMenu, close })}
...
//                   store.list.name = smd.author.endsWith("- Topic")
...
//                   import("./Lyrics").then((mod) => mod.default(dialog));
//                 }}
//               >
//                 <i class="ri-music-2-line"></i>${i18n(
...
//                     document.body.appendChild(dialog);
//                     import("./WatchVideo").then((mod) => mod.default(dialog));
//                   }
//                 }}
//               >
//                 <i class="ri-video-line"></i>${i18n(
//                   "actions_menu_watch_on",
//                   store.linkHost.slice(8)
//                 )}
//               </li>
//             `
//           : ""}
...
//             const output =
//               location.pathname === "/" ? store.player.data : store.actionsMenu;
