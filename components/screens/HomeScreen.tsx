...
const Chip = styled.TouchableOpacity<{ active?: boolean }>`
  padding: 8px 16px;
  border-radius: 999px;
  background-color: ${(p: { active?: boolean }) => (p.active ? "#a3e635" : "#262626")};
  margin-right: 8px;
  margin-bottom: 8px;
`;
    ...
    <Screen>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <HeaderRow>
          <HelloText>
            Hello,{" "}
            <HelloText style={{ fontWeight: "600" }}>John Smith</HelloText>✨
          </HelloText>
          <IconBtn>
            <Image
              source={require("../../assets/calendar-schedule-fill.png")}
