...
// export default function (_: { collection: CollectionItem; close: () => void }) {
//   const initialKeys = Object.keys(getDB());
//   store.addToCollectionOptions.length = 0;

//   for (const key of initialKeys)
//     if (!reservedCollections.includes(key)) createCollection(key);
...
//           ${i18n("collection_selector_favorites")}
//         </option>
//         <option value="listenLater">
//           ${i18n("collection_selector_listen_later")}
//         </option>
//         ${store.addToCollectionOptions.map(
