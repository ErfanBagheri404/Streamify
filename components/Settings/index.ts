...
//     settingsFrag as any,
//     html`
//       <h3 @click=${() => settingsContainer.close()}>
//         ← ${i18n("nav_settings")}
//       </h3>
//       ${app()} ${search()} ${playback()} ${library()} ${personalize()} ${partsM}
//     `
//   );
...
//       document.getElementById("actionsContainer")!.outerHTML;
//   });
// }

// async function clearCache(_: Event | undefined = undefined) {
//   await self.caches.keys().then((s) => {
//     s.forEach((k) => {
//       self.caches.delete(k);
//     });
//   });
//   await navigator.serviceWorker.getRegistrations().then((s) => {
//     s.forEach((r) => {
//       r.unregister();
//     });
//   });
...
//   if (
//     confirm(
//       "This will overwrite your current settings with the imported settings, continue?"
//     )
//   )
